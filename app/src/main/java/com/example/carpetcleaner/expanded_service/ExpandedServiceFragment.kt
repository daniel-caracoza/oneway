package com.example.carpetcleaner.expanded_service
...
class ExpandedServiceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        expandedServiceViewModel = ViewModelProvider(this, expandedServiceViewModelFactory).get(ExpandedServiceViewModel::class.java)
