package com.example.carpetcleaner.ui.services
...
class ServicesFragment : Fragment(), ServiceListener {
        ...
        servicesViewModel.navigateToExpandedService.observe(viewLifecycleOwner, Observer { serviceId ->
            serviceId?.let {
                this.findNavController().navigate(
                    ServicesFragmentDirections.actionServicesFragmentToExpandedServiceFragment(serviceId)
                )
    ...
    override fun onClick(cardView: View, service: Service) {
        ...
        val directions =
            ServicesFragmentDirections.actionServicesFragmentToExpandedServiceFragment(service.id)
