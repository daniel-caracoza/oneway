...
class ScheduledServiceAdapter(private val clickListener: ScheduledServiceListener): ListAdapter<ScheduledService, ScheduledServiceAdapter.ViewHolder>(ScheduledServiceDiffCallback()){
