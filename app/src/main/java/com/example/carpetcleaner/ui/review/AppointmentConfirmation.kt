...
import com.example.carpetcleaner.ui.review.AppointmentConfirmationDirections
...
class AppointmentConfirmation : Fragment(), ScheduledServiceListener {
    ...
    override fun onCreateView(
        ...
        binding.editcontact.setOnClickListener {
            val directions =
                AppointmentConfirmationDirections.actionAppointmentConfirmationToCustomerScheduler()
